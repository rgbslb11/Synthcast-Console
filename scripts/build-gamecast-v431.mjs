...
index=once(index,'W4-55+SCHEDULE_V5+TV54_EXACT_1_BLOCKED+POWER_W4_110_60_99+V423_UI','W4-55+SCHEDULE_V5+TV54_EXACT_1_BLOCKED+POWER_W4_110_60_99+V431_UI_RESET','data version');
...
page=once(page,'55 canonical Week 4 games from Schedule v5; all 110 participating teams carry the authorized Week 4 60–99 TEAM/OFF/DEF package and all 55 games are POWER READY.','55 canonical Week 4 games from Schedule v5; all 110 participating teams carry the authorized Week 4 60–99 TEAM/OFF/DEF package and all 55 games are POWER READY. 4.3.1 isolates browser/session identity from pre-power 4.3 sessions and adds PURGE UI + NEW SESSION.','governance corrective copy');
...
console.log(JSON.stringify({backend:path.relative(root,dstFn),ui:path.relative(root,dstUi),engine:'GC-W4-V4.3.1-RC1',week:'2026-W04',games:55,powerReady:55,sessionNamespace:'w4v431-'},null,2));
