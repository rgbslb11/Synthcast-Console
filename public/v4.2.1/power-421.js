'use strict';
window.GAMECAST_421_POWER_SOURCE="SYNTHCAST-v4.2-BLEND-2026-09-07-60_99-SIDECAR";
const GAMECAST_421_RAW=`
...
`.trim();
window.GAMECAST_421_POWER=Object.fromEntries(GAMECAST_421_RAW.split('\n').map(line=>{const [team,off,def,overall,flag,opponentBasis]=line.split('|');return [team,{offense:+off,defense:+def,specialTeams:null,overall:+overall,tempo:1.0,sourceVersion:window.GAMECAST_421_POWER_SOURCE,flag:flag||null,opponentBasis:opponentBasis||null}];}));
