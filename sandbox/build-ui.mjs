...
write('patch-rc2.js',read('v4.2/patch-rc2.js'));write('patch-422.js',read('v4.2.2/patch-422.js'));write('patch-431.js',"engine='GC-W4-V4.3.1-RC1-SANDBOX';\n");
